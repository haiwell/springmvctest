...
{   
    if (!contextPath)
        contextPath = "";
    var pathtojsfiles = contextPath + "/gcbase/js/jquery/jgrid/js/"; // need to be ajusted
    // set include to false if you do not want some modules to be included
    var combineIntoOne = false; 
    var combinedInclude = new Array();
    var combinedIncludeURL = contextPath + "/gcbase/js/jquery/jgrid/combine.php?type=javascript&files=";
    var minver = false;
    var modules = [
        { include: true, incfile:'grid.locale-zh.js',minfile: 'min/grid.locale-en-min.js'}, // jqGrid translation
